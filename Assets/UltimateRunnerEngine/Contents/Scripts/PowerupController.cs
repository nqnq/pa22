...
public class PowerupController : MonoBehaviour
{
    ...
    {
        if(GameGlobals.Instance.achievements.currentCoins <= 0 && num < 0) return;
        GameGlobals.Instance.achievements.currentCoins += num;
    }

    // 金币显示
    public IEnumerator addCoinsOnGui(int coinsTotal, float delay)
    {
        // Start delay
    ...
    public void doLetterCollected()
    {
        ...
        if (activeWord.Length == collectedWord)
        {
            ...
            StartCoroutine(addCoinsOnGui(0, 4));
    ...
    public void doFruitCollected()
    {
        ...
        if (activeFruits == collectedFruits)
        {
            ...
            StartCoroutine(addCoinsOnGui(0, 6));
    ...
    public void addAchievementPoints(string message, int points)
    {
        ...
        StartCoroutine(addCoinsOnGui(0, 3.0f));
